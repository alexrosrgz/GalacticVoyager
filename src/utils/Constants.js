export const PLANETS = [
  ...
  { name: 'Venus',   radius: 7,  distance: 300,  color: 0xe8cda0, emissive: false, orbitalSpeed: 0.035, rotationSpeed: 0.005, texture: '/textures/2k_venus_surface.jpg' },
  ...
  { name: 'Mars',    radius: 5,  distance: 600,  color: 0xcc4422, emissive: false, orbitalSpeed: 0.02,  rotationSpeed: 0.28,  texture: '/textures/2k_mars.jpg' },
  { name: 'Jupiter', radius: 30, distance: 1200, color: 0xddaa77, emissive: false, orbitalSpeed: 0.01,  rotationSpeed: 0.5,   texture: '/textures/2k_jupiter.jpg' },
  { name: 'Saturn',  radius: 25, distance: 1800, color: 0xccbb88, emissive: false, orbitalSpeed: 0.007, rotationSpeed: 0.45,  rings: true, texture: '/textures/2k_saturn.jpg', ringTexture: '/textures/2k_saturn_ring_alpha.png' },
  { name: 'Uranus',  radius: 16, distance: 2500, color: 0x66ccdd, emissive: false, orbitalSpeed: 0.004, rotationSpeed: 0.4,   texture: '/textures/2k_uranus.jpg' },
  { name: 'Neptune', radius: 15, distance: 3200, color: 0x3344bb, emissive: false, orbitalSpeed: 0.003, rotationSpeed: 0.42,  texture: '/textures/2k_neptune.jpg' },
];
